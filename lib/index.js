...
new ErAssembler();
//#endregion
//#region src/serializer/diagram-registry.ts
...
function parseMermaid(code, options) {
	...
	switch (diagramType) {
		...
		default:
			...
			if (info !== void 0 && !info.implemented) return buildParseFailure(`图表类型 "${diagramType}"（${info.label}）正在开发中，暂不支持解析（计划见 PLAN.md）`, code);
